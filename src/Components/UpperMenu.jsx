...
const UpperMenu = ({ countDown, currWordIndex }) => {
  const { setTestSeconds, setTestMode, testMode, setTestWords, testWords } =
    useTestMode();
  ...
  return (
    <div className="upper-menu">
      ...
      <div className="modees">
        <span className="mode" id="time" onClick={updateMode}>
          {" "}
          Time{" "}
        </span>
        <span className="mode" id="word" onClick={updateMode}>
          {" "}
          Word{" "}
        </span>
      </div>
      ...
      {testMode === "time" ? (
        ...
        <div className="word-modes">
          <div className="no-of-word" id={10} onClick={updateWord}>
            10
          </div>
          <div className="no-of-word" id={20} onClick={updateWord}>
            20
          </div>
          <div className="no-of-word" id={30} onClick={updateWord}>
            30
          </div>
        </div>
      )}
